(function() {
    ...
    function categorizeButtons(container) {
        ...
        var categories = {
            online: [], torrent: [], trailer: [], favorite: [], subscribe: [], book: [], reaction: [], other: []
        };
    ...
    function init() {
        var style = $('<style>' +
            '.full-start-new__buttons .full-start__button { opacity: 1 !important; }' +
