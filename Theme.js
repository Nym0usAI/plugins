(function () { 
    ...
    // Встроенные темы CSS (оставлены только стили для качества и рейтингов)
    var themes = {
        prisma: `${qualityColorsCSS} ${ratingStyles}`,
        blue: `${qualityColorsCSS} ${ratingStyles}`,
        green: `${qualityColorsCSS} ${ratingStyles}`,
        orange: `${qualityColorsCSS} ${ratingStyles}`,
        purple: `${qualityColorsCSS} ${ratingStyles}`,
        red: `${qualityColorsCSS} ${ratingStyles}`
    };
})();